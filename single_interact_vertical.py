...
df.to_csv('D:\HK\TestPipeOutput_csv\\' + csv_name, sep=',', index=False, encoding='utf_8_sig')  # 【待添加：自动创建文件夹】
...
plt.savefig('D:\HK\TestPipeOutput_image\\'+jpg_name, dpi=400)  # 【待添加：自动创建文件夹】
plt.show()
# ************************************************** #
